        ...
        <tbody>
            @foreach ($records as $data)
                <tr>
                    ...
                    <td>Rp
                        {{ number_format((float) optional($data->total_expanse->first())->total_amount ?? 0, 0, ',', '.') }}
                    </td>
            ...
            <tr>
                <td colspan="8" style="text-align: right; font-weight: bold;">TOTAL LABA BERSIH</td>
                <td colspan="2" style="font-weight: bold;">
                    Rp {{ number_format($totalLabaBersih, 0, ',', '.') }}
                </td>
            </tr>
        </tbody>
    </table>
